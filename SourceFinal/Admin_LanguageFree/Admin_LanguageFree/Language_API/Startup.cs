...
namespace Language_API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.AddPolicy(IdentifyRole.AdminRole, p => p.RequireClaim(IdentifyRole.RoleRequired, "2"));
                options.AddPolicy(IdentifyRole.ParentRoleRequired, p => p.RequireClaim(IdentifyRole.RoleRequired, "3"));
                options.AddPolicy(IdentifyRole.Match, policy =>
                {
                    policy.RequireClaim(IdentifyRole.RoleRequired, "2", "3");
                });
            });
